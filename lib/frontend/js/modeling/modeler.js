...
XMOD.CModeler = function() {
	...
	this.init = function(showGrid = false) {
		...
		//this.matdefault = new THREE.MeshPhongMaterial( { color: 0Xf06000, specular: 0x111111, shininess: 200, emissive:0x000000 } );
		this.matNormal = new THREE.MeshPhongMaterial( { color: 0Xf06000, specular: 0x111111, shininess: 200, emissive:0x000000 } );
		//this.matNormal = new THREE.MeshPhongMaterial( { color: 0Xaaaa00, specular: 0x111111, shininess: 200, emissive:0x000000 } );
		//this.matNormal = new THREE.MeshPhongMaterial( { envMap: cubemap, color: 0Xff6600, specular: 0x111111, shininess: 0x111111, emissive:0x000000, combine: THREE.MixOperation, reflectivity: 0.1 } );
		//this.matNormal = new THREE.MeshPhongMaterial( { envMap: cubemap, color: 0Xff6600, specular: 0x111111, shininess: 0xaaaaaa, emissive:0x000000, combine: THREE.MixOperation, reflectivity: 0.1 } );

		// this.matNormal = new THREE.MeshPhongMaterial( { envMap: cubemap, color: 0X55ff00, specular: 0x111111, shininess: 0xaaaaaa, emissive:0x000000, combine: THREE.MixOperation, reflectivity: 0.1 } );
		//this.matNormal = new THREE.MeshPhongMaterial( { envMap: cubemap, color: 0X55ff00, specular: 0x111111, shininess: 0xaaaaaa, emissive:0x000000, combine: THREE.MixOperation, reflectivity: 0.1 } );
		this.matNormal = new THREE.MeshPhongMaterial( { envMap: cubemap, color: 0X55ff00, specular: 0x111111, shininess: 100, emissive:0x000000, combine: THREE.MixOperation, reflectivity: 0.1 } );

		// original
		this.matNormal = new THREE.MeshPhongMaterial( { envMap: cubemap, color: 0Xffffcc, specular: 0x111111, shininess: 100, emissive:0x000000, combine: THREE.MixOperation, reflectivity: 0.15 } );
		this.matNormal = new THREE.MeshPhongMaterial( { envMap: cubemap, color: 0Xffffdd, specular: 0x111111, shininess: 100, emissive:0x000000, combine: THREE.MixOperation, reflectivity: 0.1 } );

		//this.matNormal = new THREE.MeshPhongMaterial( { envMap: cubemap, color: 0X103f6f, specular: 0x111111, shininess: 100, emissive:0x000000, combine: THREE.MixOperation, reflectivity: 0.01 } );
		//this.matNormal = new THREE.MeshPhongMaterial( { envMap: cubemap, color: 0X222222, specular: 0x111111, shininess: 100, emissive:0x000000, combine: THREE.MixOperation, reflectivity: 0.05 } );
