...
(function(root){
	...
	function SvgNest(){
		...
		this.launchWorkers = function(tree, binPolygon, config, progressCallback, displayCallback){
			...
			/*
			p.require('/js/matrix.js');
			p.require('/js/geometryutil.js');
			p.require('/js/placementworker.js');
			p.require('/js/clipper.js');
			*/

			p.add_snippet( '{{{ _js_matrix_js }}}' );
			p.add_snippet( '{{{ _js_geometryutil_js }}}' );
			p.add_snippet( '{{{ _js_placementworker_js }}}' );
			p.add_snippet( '{{{ _js_clipper_js }}}' );
			...
			p.map(function(pair){
				...
				/*
				p2.require('/js/json.js');
				p2.require('/js/clipper.js');
				p2.require('/js/matrix.js');
				p2.require('/js/geometryutil.js');
				p2.require('/js/placementworker.js');	
				*/

				p2.add_snippet( '{{{ _js_json_js }}}' );
				p2.add_snippet( '{{{ _js_clipper_js }}}' );
				p2.add_snippet( '{{{ _js_matrix_js }}}' );
				p2.add_snippet( '{{{ _js_geometryutil_js }}}' );
				p2.add_snippet( '{{{ _js_placementworker_js }}}' );
